...
import { Home, LayoutDashboard, PackageSearch, Wallet, ClipboardList } from "lucide-react";
...
export function MobileNav({ isAuthenticated }: { isAuthenticated: boolean }): JSX.Element {
  ...
  const navItems = isAuthenticated ? items : [...items.slice(0, 4), { href: "/auth" as Route, label: "Auth", icon: LayoutDashboard }];
